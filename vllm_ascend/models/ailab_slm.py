# coding=utf-8
## Adapted from
## - AILabSLM huggingface implementation
## - vllm/model_executor/models/qwen2.py [0.23.0]
...
ALL_DECODER_LAYER_TYPES = {
    "attention": AILabSLMDecoderLayer,
}
...
class AILabSLMModel(nn.Module, EagleModelMixin):
    def __init__(
        self,
        *,
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: AILabSLMDecoderLayer(
                config=config,
                cache_config=cache_config,
                quant_config=quant_config,
                prefix=prefix,
